...
const Settings = () => {
    ...
    const storedUser = JSON.parse(localStorage.getItem('user')) || { fullName: 'User', email: '' };
    ...
    const handleUpdateProfile = async (e) => {
        ...
        try {
            ...
            console.log("Sending PUT to:", `http://localhost:8080/api/v1/users/${encodedEmail}`);
    ...
    const handleChangePassword = async (e) => {
        ...
        try {
            const encodedEmail = encodeURIComponent(user.email);
            console.log("Sending PUT to:", `http://localhost:8080/api/v1/users/${encodedEmail}/password`);
